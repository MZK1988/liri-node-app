    ...
    fs.readFile("random.txt", "utf8", function (error, data) {
      ...
      spotify.search({ type: 'track', query: concatenate }, function (err, data) {
        if (err) {
          ...
          var queryUrl = "http://www.omdbapi.com/?t=" + concatenate + "&y=&plot=short&apikey=trilogy";
        ...
        console.log("hello world")
        var queryUrl = "https://rest.bandsintown.com/artists/" + concatenate + "/events?app_id=codingbootcamp"
